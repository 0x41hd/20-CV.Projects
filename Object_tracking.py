...
def main():
    ...
    while True:
        ...
        cv2.putText(frame, "ESC to quit", (100, 50),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.75, (50, 170, 50), 2)
