...
open_buttom = tk.Button(btn_frame, text="Open Image", command=open_file)
open_buttom.grid(row=0, column=0, padx=5)

save_buttom = tk.Button(btn_frame, text="Save Sketch", command=save_sketch)
save_buttom.grid(row=0, column=1, padx=5)
